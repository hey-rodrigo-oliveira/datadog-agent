...
namespace Datadog.CustomActions.Extensions
{
    ...
    public static class SessionExtensions
    {
        ...
        /// <summary>
        /// Install-location paths generated by MSI custom actions (not declared as MSI File components).
        /// </summary>
        public static List<string> InstallLocationGeneratedPaths(this ISession session)
        {
            var installLocation = session.Property("PROJECTLOCATION");

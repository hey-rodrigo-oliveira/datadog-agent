...
func TestHeartbeat_StartIsIdempotent_NoDoubleEmission(t *testing.T) {
	...
	// ~3 intervals elapsed. With one goroutine: 1 immediate + ~3 ticks = 4 emissions ±1.
	// With two goroutines (bug): ~8 emissions. Upper bound catches the bug while
	// allowing normal jitter.

...
// This product includes published at Datadog (https://www.datadoghq.com/).
...
// Stop blocks until the running goroutine has fully exited so a
// Start→Stop→Start sequence never produces overlapping emit goroutines.
...
// If the goroutine is blocked inside AddEnhancedMetric, Stop logs a warning
// and returns; the goroutine will self-clean once the channel drains.

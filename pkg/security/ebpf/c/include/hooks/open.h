...
// receive_fd installs the stolen struct file into the caller's fd table. This is
// where we can call handle_open with the actual path and update the open flags.

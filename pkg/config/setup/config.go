...
// started by the core Agent only when process_manager.enabled is true. Leaving
// data_plane.enabled true without procmgr would disable internal DogStatsD
// while no ADP process is started.
//
